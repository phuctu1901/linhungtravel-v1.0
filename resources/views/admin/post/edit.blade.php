                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-basic">CHỈNH SỬA BÀI VIẾT</h4>
                            </div>
                            <div class="card-body">
                                <div class="px-3">

                                    <form class="form form-horizontal"
                                          action="{{url('/admin/post/editRequest')}} "
                                          method="POST" role="form" enctype="multipart/form-data">
                                        {{ csrf_field()}}
                                        <div class="form-body">
                                            <input value="{{$post->id}}" name="id" id="id" type="hidden">
                                            <h4 class="form-section"><i class="ft-user"></i>Nội dung bài viết</h4>
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput1">Tên bài
                                                    viết</label>
                                                <div class="col-md-9">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input id="thumb_data" class="form-control"
                                                               type="text"
                                                               name="thumb_data" value="{{$post->thumb}}">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                            <textarea id="post_content" rows="5" class="form-control"
                                                                      name="post_content"><?php echo json_decode($post->content) ?></textarea>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput1">Tiêu
                                                    đề: </label>
                                                <div class="col-md-9">
                                                    <input id="meta_title" class="form-control"
                                                           type="text"
                                                           name="meta_title" value="{{$post->metaTitle}}">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput1">Mô
                                                    tả: </label>
                                                <div class="col-md-9">
                                                    <input id="meta_desc" class="form-control"
                                                           type="text"
                                                           name="meta_desc" value="{{$post->metaDesc}}">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput1">Từ
                                                    khóa: </label>
                                                <div class="col-md-9">
                                                    <input id="meta_kw" class="form-control"
                                                           type="text"
                                                           name="meta_kw" value="{{$post->metaKeyword}}">
                                                </div>
                                            </div>
