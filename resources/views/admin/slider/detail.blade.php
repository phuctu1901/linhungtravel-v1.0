                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-basic">Chi tiết slider</h4>
                            </div>
                            <div class="card-body">
                                <div class="px-3">
                                    ...
                                    <form class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="slider_id" class="form-control"
                                                           type="text"
                                                           name="slider_id" value="{{$slider->id}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="slider_title" class="form-control"
                                                           type="text"
                                                           name="slider_title" value="{{$slider->title}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                            <textarea id="slider_desc" rows="3" class="form-control"
                                                                      name="slider_desc">{{$slider->desc}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="slider_link" class="form-control"
                                                           type="text"
                                                           name="slider_link" value="{{$slider->link}}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input id="slider_thumb_data" class="form-control"
                                                               type="text"
                                                               name="slider_thumb_data" value="{{$slider->thumb}}">
                                        ...
                                        <div class="form-actions">
                                            <a href="/admin/slider" type="button" class="btn btn-raised btn-warning mr-1">
