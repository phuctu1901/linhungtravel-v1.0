                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-basic">Chỉnh sửa trang tĩnh</h4>
                            </div>
                            <div class="card-body">
                                <div class="px-3">

                                    <form class="form form-horizontal"
                                          action="{{url('/admin/page/editRequest')}} "
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                            <textarea id="page_content" rows="5" class="form-control"
                                                                      name="page_content"><?php echo json_decode($page->content) ?></textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="meta_title" class="form-control"
                                                           type="text"
                                                           name="meta_title" value="{{$page->metaTitle}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="meta_desc" class="form-control"
                                                           type="text"
                                                           name="meta_desc"  value="{{$page->metaDesc}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="meta_kw" class="form-control"
                                                           type="text"
                                                           name="meta_kw" value="{{$page->metaKeyword}}">
                                                </div>
                                            </div>
