...
{{--                            </li>--}}
                  ...
                  lý danh mục</span></a>
                    ...
                    <li class="has-sub nav-item"><a href="#"><i class="ft-edit"></i><span data-i18n=""
                        ...
                        <ul class="menu-content">
                            <li><a href="/admin/trendingtour" class="menu-item">Tour thịnh hành</a>
                            </li>
                  ...
                  lý người dùng</span></a>
                    ...
                    <li class="has-sub nav-item"><a href="#"><i class="ft-mail"></i><span data-i18n=""
                        ...
                        <ul class="menu-content">
                            <li><a href="/admin/request/done" class="menu-item">Chưa xử lý</a>
                            </li>
                            <li><a href="/admin/request/await" class="menu-item">Đã xử lý</a>
                            </li>
                            <li><a href="/admin/request/reject" class="menu-item">Từ chối</a>
                            </li>
                        </ul>
                    </li>
                </ul>
...
<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a
        class="customizer-close"><i
            class="ft-x font-medium-3"></i></a><a id="customizer-toggle-icon" class="customizer-toggle bg-danger"><i
    ...
    <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        <h4 class="text-uppercase mb-0 text-bold-400">Tùy chỉnh giao diện</h4>
        <p>Tùy chỉnh và hiển thị theo thời gian thực</p>
        <hr>
        <!-- Sidebar Options Starts-->
        <h6 class="text-center text-bold-500 mb-3 text-uppercase">Chọn màu nền bảng chọn</h6>
        ...
        <div class="cz-bg-image row">
            <div class="col mb-3"><img src="/asset-admin/img/sidebar-bg/01.jpg" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="/asset-admin/img/sidebar-bg/02.jpg" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="/asset-admin/img/sidebar-bg/03.jpg" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="/asset-admin/img/sidebar-bg/04.jpg" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="/asset-admin/img/sidebar-bg/05.jpg" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="/asset-admin/img/sidebar-bg/06.jpg" width="90" class="rounded"></div>
        </div>
        <!-- Sidebar BG Image Ends-->
        <hr>
        <!-- Sidebar BG Image Toggle Starts-->
        <div class="togglebutton">
            <div class="switch"><span>Chọn ảnh nền bảng chọn</span>
        ...
        <!-- Compact Menu Starts-->
        <div class="togglebutton">
            <div class="switch"><span>Bảng chọn</span>
                <div class="float-right">
                    <div class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
        ...
        <div>
            <label for="cz-sidebar-width">Chiều ngang bảng chọn</label>
            <select id="cz-sidebar-width" class="custom-select cz-sidebar-width float-right">
                <option value="small">Nhở</option>
