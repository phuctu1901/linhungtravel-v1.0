            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if (this.onlyShowCurrentMonth && calendar[row][col].month() != calendar[1][1].month()) {
                        html += '<td class="td-date td-no-show ' + date_class + cname.replace(/^\s+|\s+$/g, '') + '"' + ' data-title="' + 'r' + row + 'c' + col + '">' + '<div class="date no-show"></div>' + event_html + '</td>';
                    } else {
                        html += '<td class="td-date ' + date_class + cname.replace(/^\s+|\s+$/g, '') + '"' + ' data-title="' + 'r' + row + 'c' + col + '">' + '<div class="date">' + calendar[row][col].date() + '</div>' + event_html + '</td>';
