...
(function ($) {
                ...
                $(window).scroll(function () {
                    if ($(window).scrollTop() >= top && window.matchMedia('(min-width: ' + screen + ')').matches) {
                        ...
                        if ($('.stoped-scroll-section', body).length) {
                            ...
                            console.log('room_position:'+ $('.stoped-scroll-section', body).offset().top);
                            var sum=$('.stoped-scroll-section').height()-$('.fixed-on-mobile').height()-10;
                            if ($(window).scrollTop() >= room_position + sum&& t.css('position') == 'fixed') {
                                t.css({
                                    width    : width,
                                    position : 'fixed',
                                    top      : room_position- $(window).scrollTop()-sum,
                                    'z-index': 9
                                });
                            } else {
                                t.css({
    ...
    $('.hotel-target-book-mobile .btn', body).click(function (ev) {
        ev.preventDefault();
        ...
        check_in_out.daterangepicker({
            ...
            function (start, end, label) {
                ...
                if (window.matchMedia('(max-width: 767px)').matches) {
                    $('label', '#sticky-nav .form-date-search').hide();
                    $('.render', '#sticky-nav .form-date-search').show();
                    $('.check-in-wrapper span', '#sticky-nav .form-date-search').show();
                }
            });
    ...
    $('.field-detination').each(function () {
        ...
        $('li', dropdown_menu).on('click', function () {
            ...
            if (window.matchMedia('(max-width: 767px)').matches) {
                $('label', '#sticky-nav .field-detination').hide();
                $('.render', '#sticky-nav .field-detination').show();
            }
    ...
    $('.st-number-wrapper').each(function () {
        ...
        function numberButtonFunc($button){
            ...
            if (window.matchMedia('(max-width: 767px)').matches) {
                $('#dropdown-1 label', '#sticky-nav .field-guest').hide();
                $('#dropdown-1 .render', '#sticky-nav .field-guest').show();
            }
        }
    });
    ...
    $(document).ready(function(){
        ...
        $('.st-trending-tour').each(function () {
            $(this).owlCarousel({
                loop:true,
                items: 4,
                margin: 30,
    ...
    if($('.logo').length){
        ...
        if($('.has-mega-menu .mega-menu').length){
            var fullWidth = $('.has-mega-menu .mega-menu').width();

            $('.has-mega-menu .mega-menu').css({
                //width: (winDowsWidth - (logoWidth + 60) * 2) + 'px',
                left: (logoWidth + 60) + 'px',
            });
            //$('.has-mega-menu .mega-menu').
            $(window).resize(function () {
                var winDowsWidth = $('#header').width();
                if(winDowsWidth < 1410){
...
function customControlGoogleMap(mapEl, map) {
    ...
    dropdownStyles.querySelectorAll('.item').forEach(function (item) {
